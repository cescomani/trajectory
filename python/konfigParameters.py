...
from road import erzeugHindernis 
...
def systemInit():
    ...
    return Nx, Nu, ord_mpc, T_mpc, N_mpc, Q_mpc, R_mpc, q, vmax

#Referenztrajektorie
def ReferenzTrajektorie():
    temp1, temp2, temp3 = testStrecke1()
    Xref = np.array([temp1[0],temp1[1]])

    X0 = np.array([Xref[0,0], Xref[1,0], 0, 0, 0])
    return X0, Xref, temp2, temp3
 
 
#Hindernis Modelieren 
def HindernisseModelieren(Xref):
    #global car, obstList_wk
